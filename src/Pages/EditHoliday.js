...
function EditHoliday() {
    ...
    useEffect(() => {
        fetch(`http://agazatyapi.runasp.net/api/Holiday/GetHolidayById/${holidayID}`)
            .then((res) => res.json())
            .then((data) => {
    ...
    const updateHoliday = async (e) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await fetch(`http://agazatyapi.runasp.net/api/Holiday/UpdateHoliday/${holidayID}`, {
                        method: "PUT",

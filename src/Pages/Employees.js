...
import { faCalendarDays, faIdCard, faPenToSquare, faTable, faTrash, faUserMinus, faUserPen, faUserSlash } from "@fortawesome/free-solid-svg-icons";
...
function Employees({userRole}) {
    ...
    const handleDownload = async () => {
        try {
            const response = await fetch(`http://agazatyapi.runasp.net/api/Account/export-active-users-excel`, {
                method: 'GET',
            });
            ...
            a.href = url;
            a.download = 'active-users.xlsx'; // اسم الملف

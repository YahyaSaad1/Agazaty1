                        ...
                        {sickLeavesWaiting.map((leave, index) => {
                            return(
                                <tr key={index}>
                                    ...
                                    {leave.certified === true && leave.responseDoneFinal === true ? <th className="text-success">محتسبة</th>
                                    : leave.certified === false && leave.responseDoneFinal === true ? <th className="text-danger">غير محتسبة</th>

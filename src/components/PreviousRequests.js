                                    ...
                                    <tr key={index}>
                                        ...
                                        <th>
                                            {leave.holder === 0 ? <span className='text-primary cursor-pointer' title={leave.coworkerName}>في انتظار القائم بالعمل</span>
                                                ...
                                                : leave.coWorker_Decision === false ? <span className='text-danger cursor-pointer' title={leave.NoCoworkerManagerName}>مرفوضة من القائم بالعمل</span>
                                                : leave.directManager_Decision === false ? <span className='text-danger cursor-pointer' title={leave.NoDirectManagerName}>مرفوضة من المدير المباشر</span>
                                                : leave.generalManager_Decision === false ? <span className='text-danger cursor-pointer' title={leave.NoGeneralManagerName}>مرفوضة من المدير المختص</span>

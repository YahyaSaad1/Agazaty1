...
<div>
                                            {user.leaveSection === 0 ? <h3>باقي {0 - user.normalLeavesCount}</h3>
                                            : user.leaveSection === 1 ? <h3>باقي {15 - user.normalLeavesCount}</h3>
                                            : user.leaveSection === 2 ? <h3>باقي {36 - user.normalLeavesCount}</h3>
                                            : user.leaveSection === 3 ? <h3>باقي {45 - user.normalLeavesCount}</h3>
                                            : <h3>باقي {60 - user.normalLeavesCount}</h3>}
                                        </div>
                                        <div>
                                            <h5>{leaveType}</h5>
                                        </div>
                                ...
                                :leaveType === "عارضة" ?
                                    <div>
                                        ...
                                        <div>
                                            {user.leaveSection === 0 ? <h3>باقي {4 - user.casualLeavesCount}</h3>
                                            : user.leaveSection === 1 ? <h3>باقي {3 - user.casualLeavesCount}</h3>
                                            : <h3>باقي {7 - user.casualLeavesCount}</h3>}
                                        </div>
                                        <div>
                                            <h5>{leaveType}</h5>
                                        </div>
                                ...
                                :leaveType === "مرضية" ?
                                    <div>
                                        ...
                                        <div>
                                            <h3>مأخوذ {user.nonChronicSickLeavesCount}</h3>
                                        </div>
                                        <div>
                                            <h5>{leaveType}</h5>
                                        </div>
